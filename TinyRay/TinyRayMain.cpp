...
void PrintUsage()
{
	printf("F1: Ray Tracing  (Diffuse and Specular Lighting, Shadow, Reflection)\n");
	printf("F2: Path Tracing (Sample Count of 50)\n");
	printf("F3: Path Tracing (Sample Count of 100)\n");
	printf("F4: Path Tracing (Sample Count of 500)\n\n");
}
